...
e?"fixed":"absolute");(b.browser.msie||a.forceIframe)&&k.css("opacity",0);g=[k,h,f];var o=e?b("body"):b(d);b.each(g,function(){this.appendTo(o)});a.theme&&a.draggable&&b.fn.draggable&&f.draggable({handle:".ui-dialog-titlebar",cancel:"li"});g=v&&(!b.boxModel||b("object,embed",e?null:d).length>0);if(r||g){e&&a.allowBodyStretch&&b.boxModel&&b("html,body").css("height","100%");if((r||!b.boxModel)&&!e){g=parseInt(b.css(d,"borderTopWidth"))||0;i=parseInt(b.css(d,"borderLeftWidth"))||0;var m=g?"(0 - "+g+
